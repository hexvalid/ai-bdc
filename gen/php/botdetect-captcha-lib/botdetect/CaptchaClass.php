...
class Captcha
{
    public function __construct($_l51uo2g511qjdq6zfpa5f, $_if49e56s8nqsohdg = null)
    {
        ...
        $this->_otc0ouale8wrhglbyl9towafu1 = $this->_1jrznqqgj5fxe5wbyqoen->CaptchaId;
        $this->_ol9r98laxg81kqs3ycgukwbza0 = $this->_1jrznqqgj5fxe5wbyqoen->Settings;
        $this->_169bhoa9fybrl8m9p0zkh7nydd = $this->_ol9r98laxg81kqs3ycgukwbza0->ImageTooltip;
        $this->_142l45frtm4of7iio427rhm5mj = $this->_ol9r98laxg81kqs3ycgukwbza0->SoundTooltip;
        $this->_19ivxkmt0fqhnf1q = $this->_ol9r98laxg81kqs3ycgukwbza0->ReloadTooltip;
        $this->_0tbu96wvzwgow4imkyuwr9tnvl = $this->_ol9r98laxg81kqs3ycgukwbza0->HelpLinkText;
        $this->_ipq7ah9dfk8h5pq8 = $this->_ol9r98laxg81kqs3ycgukwbza0->HelpLinkUrl;
        $this->_l2l1ltojzg8epg9wvegcr = $this->_ol9r98laxg81kqs3ycgukwbza0->ReloadEnabled;
        $this->_o2q6a7pp6pc8h3y28d6t1yd5lx = $this->_ol9r98laxg81kqs3ycgukwbza0->UseSmallIcons;
        $this->_0fuwgrrrcn6m9a5m = $this->_ol9r98laxg81kqs3ycgukwbza0->UseHorizontalIcons;
        $this->_07956dd9tul3fy51 = $this->_ol9r98laxg81kqs3ycgukwbza0->SoundIconUrl;
        $this->_Iprg2qaljb6xn5wbxsj35a7xdy = $this->_ol9r98laxg81kqs3ycgukwbza0->ReloadIconUrl;
        $this->_i5oc8l6wu6ynscyeqh422jsain = $this->_ol9r98laxg81kqs3ycgukwbza0->IconsDivWidth;
        $this->m_TabIndexStart = -255;
        $this->_1wkj0f4p45143ei4e83by = $this->_ol9r98laxg81kqs3ycgukwbza0->AdditionalCssClasses;
        $this->_070t26b9hzzhmqoh = $this->_ol9r98laxg81kqs3ycgukwbza0->AdditionalInlineCss;
        $this->_0qm2bh17tru8w32oxq5t7bp2ei = $this->_ol9r98laxg81kqs3ycgukwbza0->AddScriptInclude;
        $this->_o4fdlaizkj8suwjhb14g7 = $this->_ol9r98laxg81kqs3ycgukwbza0->AutoFocusInput;
        $this->_Iwj9dkzweuz26cyi = $this->_ol9r98laxg81kqs3ycgukwbza0->AutoClearInput;
        $this->_lpy16rt3s3ni2j4t4lhg9 = $this->_ol9r98laxg81kqs3ycgukwbza0->AutoUppercaseInput;
        $this->_1a8u7qvq1df7nd1wxo1h6 = $this->_ol9r98laxg81kqs3ycgukwbza0->AutoReloadExpiredCaptchas;
        $this->_ixkw2doq80vlu9vdn2dtyhm62q = $this->_ol9r98laxg81kqs3ycgukwbza0->AutoReloadTimeout;
        $this->_O23smk58qcugqizj23j7bc16b4 = $this->_ol9r98laxg81kqs3ycgukwbza0->SoundStartDelay;
        $this->_lhqp99sucnxaqr3egtw0l = $this->_ol9r98laxg81kqs3ycgukwbza0->RemoteScriptEnabled;
        $this->ImageColorMode = $this->_ol9r98laxg81kqs3ycgukwbza0->ImageColorMode;
        $this->JavaScriptRequired = $this->_ol9r98laxg81kqs3ycgukwbza0->JavaScriptRequired;
        new BDC_CaptchaLogging($this->_ol9r98laxg81kqs3ycgukwbza0->ErrorLoggingEnabled);
        $this->Load();
    }
    ...
    {
        if ($this->SoundPackageMissing && $this->_ol9r98laxg81kqs3ycgukwbza0->WarnAboutMissingSoundPackages) {
    ...
    {
        return $this->_1jrznqqgj5fxe5wbyqoen->IsLocalizedPronunciationAvailable;
    }
    ...
    protected function Load()
    {
        ...
        if (BDC_CodeCollection::IsValid($_1tnk71cse7sqsws2xugla649k9)) {
            $this->CaptchaBase->CodeCollection = $_1tnk71cse7sqsws2xugla649k9;
        }
    ...
    public function Save()
    {
        ...
        $this->SavePw($this);
        $this->_1jrznqqgj5fxe5wbyqoen->Save();
    ...
    {
        $this->_1jrznqqgj5fxe5wbyqoen->SaveCodeCollection();
    }
    ...
    public function SavePw($_1ysg4brhplo7topn)
    {
        if ($_1ysg4brhplo7topn->UseM()) {
            $_0li2q4nhnm164gmu = $_1ysg4brhplo7topn->CaptchaBase->PC;
    ...
    {
        return $this->_1jrznqqgj5fxe5wbyqoen->PC->GenP($_15xbrv4aekfkv9hozlrzm2ly1h, $this->_1jrznqqgj5fxe5wbyqoen->CodeTimeout);
    }
    ...
    public function Validate($_oatduwrb5m7ietl9msk4feia02 = null, $_Ithhkenyz06b9w80 = null)
    {
        ...
        if (isset($_oatduwrb5m7ietl9msk4feia02) && isset($_Ithhkenyz06b9w80)) {
            $_oprdp4ms1idbnkjj = $this->_1jrznqqgj5fxe5wbyqoen->Validate($_oatduwrb5m7ietl9msk4feia02, $_Ithhkenyz06b9w80, BDC_ValidationAttemptOrigin::Server, $this->UseM());
        }
    ...
    public function AjaxValidate($_Oclfhsfrijv4btm2rc7ml5fvy5 = null, $_0aele7u4ryahmdwg = null)
    {
        ...
        if (isset($_Oclfhsfrijv4btm2rc7ml5fvy5) && isset($_0aele7u4ryahmdwg)) {
            $_1udd04yygagzyu9mwtal4 = $this->_1jrznqqgj5fxe5wbyqoen->Validate($_Oclfhsfrijv4btm2rc7ml5fvy5, $_0aele7u4ryahmdwg, BDC_ValidationAttemptOrigin::Client, $this->UseM());
        }
    ...
    {
        return ($this->IsJavaScriptRequired() && ($this->_1jrznqqgj5fxe5wbyqoen->UserInputID != null) && !$this->TestModeEnabled);
    }
    ...
    public function Html()
    {
        ...
        $_06el0yshzw5cqwd7j3gxz26sm1 .= "<br>";
    ...
    private function uq1jk($_Otyr0xqsd8x290m1)
    {
        if ($this->RenderIcons) {
            ...
            if ($this->SoundEnabled) {
                ...
                } else if ($this->_ol9r98laxg81kqs3ycgukwbza0->WarnAboutMissingSoundPackages) {
    ...
    private function im7af($_1vt7yc3x6nver9vc9wt5a)
    {
        ...
        if ($this->UseM()) {
            $_1vt7yc3x6nver9vc9wt5a .= "\40\40\40\x20\74\151\x6e\160\165\x74\x20\164\x79\x70\145\x3d\"\150\x69\144\144\x65\156\"\x20\x6e\141\155\145\75\"\102\x44\x43\x5f\x48\x73\x5f{$this->_Ovtxzyah0c5ctro4t3vrk}\"\40\151\144\x3d\"\x42\x44\103\137\x48\163\137{$this->_Ovtxzyah0c5ctro4t3vrk}\"\x20\166\x61\154\x75\x65\x3d\"{$this->_Ip0ph4xsyb7i66bg->GetHs()}\"\x20\x2f\x3e\r\n";
            $_1vt7yc3x6nver9vc9wt5a .= "\x20\40\40\x20\x3c\x69\156\160\x75\164\x20\164\171\x70\145\x3d\"\x68\151\x64\144\x65\156\"\40\x6e\x61\x6d\x65\x3d\"\102\104\103\137\x53\120\137{$this->_Ovtxzyah0c5ctro4t3vrk}\"\x20\151\x64\75\"\102\104\103\x5f\123\x50\x5f{$this->_Ovtxzyah0c5ctro4t3vrk}\"\x20\x76\x61\x6c\x75\145\x3d\"{$this->_Ip0ph4xsyb7i66bg->GetSP()}\"\40\57\76\r\n";
        }
    ...
    public function __get($_Ounq4kf6b0r2ba2fdsrap)
    {
        if (method_exists($this->_1jrznqqgj5fxe5wbyqoen, ($_Om30lmz0quh2s75vem0hb = "\147\x65\164\137" . $_Ounq4kf6b0r2ba2fdsrap))) {
            return $this->_1jrznqqgj5fxe5wbyqoen->$_Om30lmz0quh2s75vem0hb();
    ...
    public function __isset($_Iqpfzlibo9uemmsk)
    {
        if (method_exists($this->_1jrznqqgj5fxe5wbyqoen, ($_1lv9ogxxe5opju6tx5f3xdvnrh = "\151\x73\x73\145\x74\x5f" . $_Iqpfzlibo9uemmsk))) {
            return $this->_1jrznqqgj5fxe5wbyqoen->$_1lv9ogxxe5opju6tx5f3xdvnrh();
    ...
    public function __set($_Izwrc5q78bae3ffrs9jdw, $_od0airelflv8rc2o)
    {
        if (method_exists($this->_1jrznqqgj5fxe5wbyqoen, ($_izl20pqd26zwpj71s8f5h = "\163\x65\x74\137" . $_Izwrc5q78bae3ffrs9jdw))) {
            $this->_1jrznqqgj5fxe5wbyqoen->$_izl20pqd26zwpj71s8f5h($_od0airelflv8rc2o);
    ...
    public function __unset($_1iq2vwl2bfwfb8h3v7xv1)
    {
        if (method_exists($this->_1jrznqqgj5fxe5wbyqoen, ($_iac8g0wobo2e268z = "\x75\x6e\163\145\164\137" . $_1iq2vwl2bfwfb8h3v7xv1))) {
            $this->_1jrznqqgj5fxe5wbyqoen->$_iac8g0wobo2e268z();
